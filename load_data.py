...
def load_data(patient, date, shift, batch, file_idx, folder, modality):
    """
    Loads a matlab timetable containing a specific EMG-ACC recording and its time-stamps (generated by TSG.mat)
    ...
    -modality: either 'emg' (get EMG data only), 'acc' (get accelerometry data only), or 'both' (get both EMG and accelerometry data).
